...
from app.api.deps import SessionDep, authorize_admin, authorize_organizer, get_current_user, CurrentUser
...
def update_venue(db:SessionDep, venue_id:int,venue:schemas.VenueBase):
    ...
    #upcoming_events = get_events_by_venue(db=db, venue_id=venue_id)
